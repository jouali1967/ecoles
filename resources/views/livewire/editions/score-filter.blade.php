    ...
    <div class="card-body p-2">
      <form wire:submit.prevent="rechercher">
        <div class="row g-2 align-items-end">
          ...
          <div class="col-md-2">
            <div class="form-group mb-0">
              <label for="superieur_a" class="form-label small">Supérieur à</label>
              <input type="number" step="any" wire:model="superieur_a" id="superieur_a"
                class="form-control form-control-sm" placeholder=">= ...">
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-0">
              <label for="inferieur_a" class="form-label small">Inférieur à</label>
              <input type="number" step="any" wire:model="inferieur_a" id="inferieur_a"
                class="form-control form-control-sm" placeholder="<= ...">
            </div>
          </div>
