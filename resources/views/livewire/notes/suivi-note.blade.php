            ...
            <div class="form-group mb-0">
              ...
              <div class="input-group input-group-sm">
                ...
                <input type="text" class="form-control border-start-0 rounded-end"
                  placeholder="Rechercher un étudiant..." wire:model.live="searchEtudiant" style="border-radius: 20px;">
            ...
            <div class="table-responsive" style="max-height: calc(100vh - 250px);">
              <table class="table table-sm table-hover table-striped table-bordered mb-0">
                ...
                <tbody>
                  ...
                  $notesPartielles = array_filter([$note->note1, $note->note2, $note->note3, $note->note4], function($n)
                  { return $n !== null; });
