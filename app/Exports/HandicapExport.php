...
class HandicapExport implements FromArray, WithHeadings, WithEvents
{
  ...
  {
    return [
      ['لائحة ذوي الاحتياجات الخاصة'],
      [],
      // Ordre inversé pour l'arabe : téléphone, classe, nom complet, code massar
      ['نوع الاعاقة', 'المستوى الدراسي', 'الاسم والنسب', 'رقم مسار'],
    ];
  }
    ...
    return [
      AfterSheet::class => function (AfterSheet $event) {
        ...
        foreach ($this->headings() as $heading) {
          $headerCount++;
          if ($heading === ['نوع الاعاقة', 'المستوى الدراسي', 'الاسم والنسب', 'رقم مسار']) {
            break;
          }
        }
